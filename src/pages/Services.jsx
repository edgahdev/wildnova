            ...
            <div className="services-grid">
              {additionalServices.map((service, index) => (
                <div key={index} className="service-card reveal" style={{ animationDelay: `${index * 0.1}s` }}>
                  ...
                  <Link to="https://wa.me/254792157566?text=Hello%20Wildnova%2C%20I%20would%20like%20to%20inquire%20about%20your%20tour%20packages." className="card-link">
                    Inquire <span>→</span>
                  </Link>
                </div>
              ))}
          ...
          <div className="container">
            <div className="cta-content reveal">
              ...
              <div className="cta-buttons">
                ...
                <Link to="https://wa.me/254792157566?text=Hello%20Wildnova%2C%20I%20would%20like%20to%20inquire%20about%20your%20tour%20packages." className="cta-btn secondary">Contact Us</Link>
              </div>
            </div>
          </div>
        </section>
